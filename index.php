        ...
        <div class="partido categoria-<?= $categoria ?>">
          <div class="equipos">
            <div class="equipo local">
              ...
              <img src="/public/img/uploads/<?= htmlspecialchars($partido['equipo_local_escudo'] ?? 'default.png') ?>" alt="Escudo <?= htmlspecialchars($partido['equipo_local']) ?>" />
            ...
            <div class="equipo visitante">
              ...
              <img src="/public/img/uploads/<?= htmlspecialchars($partido['equipo_visitante_escudo'] ?? 'default.png') ?>" alt="Escudo <?= htmlspecialchars($partido['equipo_visitante']) ?>" />
