...
// Cambiado a categoría 2ªRegional
$partidos = Partido::obtenerPorCategoria('2ªRegional');
$clasificacion = [];
...
foreach ($partidos as $p) {
    ...
    if ($gfL > $gcL) {
        ...
        $clasificacion[$idL]['E']++;
        $clasificacion[$idL]['Pts']++;
        $clasificacion[$idV]['E']++;
        $clasificacion[$idV]['Pts']++;
    }
}
...
// Orden por Pts, luego DF, luego GA
